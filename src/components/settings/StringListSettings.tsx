    ...
    <div>
      ...
      {displayList.length === 0 && !isEditing ? (
        <EmptyState
          ...
          action={canEdit ? (
            <button onClick={handleEnterEdit} style={addBtnStyle}>
              + Add {label.replace(/s$/, "")}
            </button>
          ) : undefined}
        />
            ...
            return (
              ...
              >
                ...
                {showDept && (isEditing ? (
                  ...
                  <div style={{ fontSize: "var(--dg-fs-label)", fontWeight: 500, color: item.departmentId ? "var(--color-text-secondary)" : "var(--color-text-faint)" }}>
