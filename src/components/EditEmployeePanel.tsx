        ...
        <div style={{ borderTop: "1px solid var(--color-border-light)", paddingTop: 16, paddingBottom: 4 }}>
          {pendingInvitation ? (
            ...
            <button
              ...
              className="dg-btn dg-btn-ghost"
              style={{ color: "var(--color-link)", fontSize: "var(--dg-fs-caption)", padding: "6px 10px", width: "100%", justifyContent: "center", border: "1px dashed var(--color-info-border)", borderRadius: 10 }}
            >
