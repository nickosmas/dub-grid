...
import { createCompany, assignCompanyRoleByEmail } from "@/lib/db";
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (superAdminEmail.trim()) {
        try {
          await assignCompanyRoleByEmail(company.id, superAdminEmail.trim(), "super_admin");
          toast.success(`Company created and ${superAdminEmail.trim()} assigned as super admin`);
        } catch (err: any) {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ maxWidth: 680 }}>
      ...
      <div style={{ ...sectionStyle, marginBottom: 20 }}>
        <div style={sectionHeaderStyle}>Company Details</div>
      ...
      <div style={{ ...sectionStyle, marginBottom: 24 }}>
        ...
        <div style={sectionBodyStyle}>
          <p style={{ margin: "0 0 12px", fontSize: 13, color: "var(--color-text-muted)" }}>
            Assign an existing user as the company super admin. The user must already have a Supabase account.
          </p>
