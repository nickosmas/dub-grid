          ...
          {EMPLOYEES.map((emp) => {
            ...
            return [
              ...
              ...emp.shifts.map((shiftIdx, dayI) => {
                const shift =
                  shiftIdx !== null ? SHIFT_CODES[shiftIdx] : null;
                const isToday = dayI === TODAY_INDEX;
                return (
                  <div
                    key={`${emp.name}-${dayI}`}
                    style={{
