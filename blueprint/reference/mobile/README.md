...
| alerts-ios-light-default-admin                                                               | captured | Mailbox rows: unread rows tinted brandSoft (the web unread tint) with a dot and semibold title, read rows on the page background, time, two-line message                                                                                               |
| alerts-ios-dark-ax-admin                                                                     | captured | Same rows in dark at accessibility extra-large: the unread tint is the dark brandSoft, read rows stay on the page background                                                                                                                           |
