...
There are exactly 4 migration files. Never create a 005 or later. Add new tables, functions, policies, and grants to the appropriate file in the correct section.
