...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-[var(--dg-tab-shell-radius)] p-[var(--dg-tab-shell-pad)] text-muted-foreground group-data-horizontal/tabs:h-[var(--dg-toolbar-h)] group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:h-auto data-[variant=line]:rounded-none data-[variant=line]:p-0",
  {
    variants: {
      variant: {
        default: "bg-muted",
