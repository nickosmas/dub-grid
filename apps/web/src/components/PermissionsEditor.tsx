...
export const PERMISSION_MODULES: PermissionModule[] = [
  ...
  },
  {
    ...
    icon: "settings",
    category: "ADMINISTRATION",
    viewKeys: ["canViewFocusAreas", "canViewScheduleDefinitions", "canViewIndicatorTypes", "canViewOrgLabels"],
    editKeys: ["canManageFocusAreas", "canManageScheduleDefinitions", "canManageIndicatorTypes", "canManageOrgLabels"],
  },
  {
    id: "org-settings",
