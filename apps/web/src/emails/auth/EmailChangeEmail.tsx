...
export function EmailChangeEmail({ logoUrl }: { logoUrl?: string } = {}) {
  return (
    <AuthActionEmail
      ...
      intro="Confirm the new email address for your DubGrid sign-in using the button below. The link expires in 1 hour."
      ctaLabel="Confirm change"
      footer="If you didn't request this change, don't confirm it, and contact support@dubgrid.com if you think someone else is using your sign-in."
      logoUrl={logoUrl}
    />
  );
}
