...
export function InviteEmail({
  ...
  return (
    ...
    >
      <Text style={styles.heading}>{reissue ? "Your new invitation" : "You're invited"}</Text>
      <Text style={styles.paragraph}>
        {reissue ? (
          <>
            Here&apos;s a new invitation to join <strong>{orgName}</strong> on DubGrid. It replaces
            your earlier one, so the link in any earlier invitation email no longer works.
          </>
        ) : (
          <>
      ...
      <Text style={styles.fine}>
        ...
        If we send you a new invitation, only the link in the newest email will work. If you
