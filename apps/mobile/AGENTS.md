...
| Icons           | Ionicons filled variants only, never `-outline`; a checkmark is `checkmark`, never the double `checkmark-done`. Tab bars carry the filled glyph in both states and let colour mark the selection                                                                                                                                                                                                                                                              |
...
| Dashboard       | No pills: a status is a tone-coloured word, a count is a figure, a type is a coloured word in the caption; every card's affordance is the header-right "See all ›"                                                                                                                                                                                                                                                                                            |
