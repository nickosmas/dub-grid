...
| `profile_change_requests`                                                   | manager-approved profile requests and super-admin-approved account-deletion requests                                                                                                                                                                                                                                                                                                                                    |
...
> `internal/architecture/folder-structure.md` describes the full feature/data-access layout. The remaining `apps/web/src/lib/*` modules (besides `lib/db/`) are compatibility shims.
...
| --------------------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Production migration safety | Must     | The final release gate (build-plan item 37): inventory and reconcile the linked production ledger, rehearse on a production-shaped branch, apply only reviewed forward migrations. Runbook in `internal/operations/production-migration-safety.md`. |
