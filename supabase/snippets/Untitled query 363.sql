...
BEGIN
  ...
  -- Assign as gridmaster — no company affiliation needed
  INSERT INTO public.profiles (id, company_id, platform_role, company_role)
  VALUES (gm_user_id, NULL, 'gridmaster', 'user')
