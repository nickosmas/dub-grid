-- Migration 084: Fix custom_access_token_hook volatility
--
-- The hook contains DELETE statements (jwt_refresh_locks cleanup) but was
-- declared STABLE, which PostgreSQL rejects at runtime. Change to VOLATILE.
